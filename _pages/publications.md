...
## Conference Papers
* **[ISSCC'22]** **F. Tu**,  Y. Wang, Z. Wu, L. Liang, Y. Ding, B. Kim, L. Liu, S. Wei, Y. Xie, S. Yin, "[A 28nm 29.2TFLOPS/W BF16 and 36.5TOPS/W INT8 Reconfigurable Digital CIM Processor with Unified FP/INT Pipeline and Bitwise in-Memory Booth Multiplication for Cloud Deep Learning Acceleration](https://ieeexplore.ieee.org/document/9731762)," International Solid-State Circuits Conference (ISSCC), 2022. 
...
* **[ISCA'22]** J. Lin, L. Liang, Z. Qu, I. Ahmad, L. Liu, **F. Tu**, Y. Ding, Y. Xie, T. Gupta, "INSPIRE: In-Storage Private Information Retrieval via Protocol and Architecture Co-design," International Symposium on Computer Architecture (ISCA), New York City, USA, 2022. (**Acceptance Rate: 16.8% = 67/400**) 	
